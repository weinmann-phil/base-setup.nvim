vim.wo.number = true 		-- Set default line numbers
vim.o.relativenumber = true 	-- Set relative numbers as default
...
vim.o.softtabstop = 2 		-- Number of spaces that a tab counts for a while
